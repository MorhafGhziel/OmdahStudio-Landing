          ...
          <div className="flex gap-4 sm:gap-6 md:gap-8 overflow-x-auto pb-4 snap-x snap-mandatory">
            {gridWorks.map((work, index) => (
              <motion.div
                ...
                className="group flex-shrink-0 w-[280px] sm:w-[300px] md:w-[600px] snap-center"
                onMouseEnter={() => setHoveredWork(work.id)}
                onMouseLeave={() => setHoveredWork(null)}
              >
                <div className="relative w-full h-[280px] sm:h-[300px] md:h-[600px] rounded-xl sm:rounded-2xl overflow-hidden">
                  <Image
                    src={work.image}
                    alt={work.title}
                    fill
